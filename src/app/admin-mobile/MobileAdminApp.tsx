	                      ...
	                      >
	                        <div className="grid gap-4 sm:grid-cols-2">
	                          ...
	                          <label className="block sm:col-span-2">
	                            ...
	                            <input
	                              type="url"
	                              value={editorEntry.sourceUrl}
	                              onChange={(event) => updateEntry({ sourceUrl: event.target.value })}
	                              className="w-full rounded-[1rem] border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-teal-500"
	                              placeholder="https://careers.company.com/job/..."
	                            />
	                            <p className="mt-2 text-xs text-slate-500">
	                              Use the exact official page checked. This is shown as the verification source, separate from the apply button.
	                            </p>
	                          </label>
	                          ...
	                          <label className="block">
	                            ...
	                            <select
	                              value={editorEntry.sourceType}
	                              onChange={(event) => updateEntry({ sourceType: event.target.value })}
	                              className="w-full rounded-[1rem] border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-teal-500"
	                            >
	                              <option value="Official employer careers page">Official employer careers page</option>
	                              <option value="Official employer applicant-tracking page">Official employer applicant-tracking page</option>
	                              <option value="Official university or government page">Official university or government page</option>
	                            </select>
	                          </label>
	                          ...
	                          <label className="block">
	                            ...
	                            <input
	                              type="date"
	                              value={editorEntry.sourceCheckedAt}
	                              onChange={(event) => updateEntry({ sourceCheckedAt: event.target.value })}
	                              className="w-full rounded-[1rem] border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-teal-500"
	                            />
	                          </label>
