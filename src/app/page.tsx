...
export default async function HomePage() {
  ...
  const hasPublishedJobs = allJobs.length > 0;
  const heroMetrics = hasPublishedJobs
    ? [
    ...
    : [
        { value: "Fresh", label: "Start", note: "new catalogue" },
        { value: "Clear", label: "Standards", note: "quality first" },
        { value: "Soon", label: "New roles", note: "being reviewed" },
      ];
  ...
  const heroTrustSignals = hasPublishedJobs
    ? [
    ...
    : [
        { value: "Fresh start", label: "a new catalogue is being prepared" },
        { value: "Student-first", label: "built for students and freshers" },
        { value: "Quality first", label: "only verified listings will be published" },
      ];
  const dashboardMetrics = hasPublishedJobs
    ? [
    ...
    : [
        { value: "Fresh", label: "Catalogue" },
        { value: "Quality", label: "First" },
        { value: "Soon", label: "New roles" },
      ];
  const dashboardStatusLabels = hasPublishedJobs
    ? ["Checked", "Direct", "Fresh", "Open"]
    : ["Preparing", "Review", "Quality", "Soon"];
  ...
  const dashboardRecommendationTags = hasPublishedJobs
    ? ["Source checked", "Fast apply", "Fresh listing", "Open role"]
    : ["Fresh start", "Quality first", "Clear sources", "New catalogue"];
  const dashboardChecks = hasPublishedJobs
    ? ["Original source", "Role clarity", "No paid routes"]
    : ["Source checks", "Role clarity", "No paid routes"];
            ...
            <div className="home-hero-copy mx-auto max-w-3xl text-center lg:mx-0 lg:max-w-[38rem] lg:text-left">
              <div className="home-hero-copy-stack">
                ...
                <div className="home-hero-badge-row flex flex-wrap items-center justify-center lg:justify-start">
                  ...
                  <span className="home-hero-live-pill hidden lg:inline-flex">
                    {hasPublishedJobs ? "Updated daily" : "Fresh start"}
                  </span>
                </div>
