...
export default function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 mx-auto w-full max-w-6xl px-3 pt-1.5 min-[360px]:px-4 min-[360px]:pt-2 sm:px-6 sm:pt-3 lg:px-8 lg:pt-2">
      <div
        className={`fade-up header-shell relative rounded-[1.15rem] px-3 py-2 min-[360px]:px-3.5 min-[360px]:py-2.25 sm:rounded-2xl sm:px-5 sm:py-2.5 lg:px-4 lg:py-1.5 ${
        ...
        <div className="flex items-center justify-between gap-1.5 sm:hidden">
          <Link href="/" aria-label="JobAdvice Home" className="inline-flex min-w-0 items-center">
            <Image
              ...
              height={76}
              priority
              className="jobadvice-logo-light h-auto max-w-full w-[104px] min-[360px]:w-[116px]"
            />
            <Image
              src="/jobadvice-logo-dark.svg"
              alt="JobAdvice"
              ...
              height={76}
              priority
              className="jobadvice-logo-dark h-auto max-w-full w-[104px] min-[360px]:w-[116px]"
            />
          </Link>
          ...
          <div className="flex items-center gap-1.5 min-[360px]:gap-2">
            <Link
              ...
              className="utility-button h-9 w-9 px-0 min-[360px]:h-10 min-[360px]:w-10"
            >
              <svg
                aria-hidden="true"
                viewBox="0 0 20 20"
            ...
            >
              <svg
                aria-hidden="true"
                viewBox="0 0 20 20"
                className={`h-[17px] w-[17px] transition-transform min-[360px]:h-[18px] min-[360px]:w-[18px] ${isMenuOpen ? "rotate-90" : ""}`}
              >
                <path
